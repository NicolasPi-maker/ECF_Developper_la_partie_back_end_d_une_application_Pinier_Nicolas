 ...
 */
final class Version20220825114046 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE candidate_job_offer ADD job_offers_id_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE candidate_job_offer ADD CONSTRAINT FK_37F1E7622B57C3AD FOREIGN KEY (job_offers_id_id) REFERENCES job_offer (id)');
        $this->addSql('CREATE INDEX IDX_37F1E7622B57C3AD ON candidate_job_offer (job_offers_id_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE candidate_job_offer DROP FOREIGN KEY FK_37F1E7622B57C3AD');
        $this->addSql('DROP INDEX IDX_37F1E7622B57C3AD ON candidate_job_offer');
        $this->addSql('ALTER TABLE candidate_job_offer DROP job_offers_id_id');
    }
}
